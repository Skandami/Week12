...
const makeEleven = () => {
	resultEleven.textContent = 81 % 2; //результат задания номер 5??
};
...
const makeTwelve = () => {
	const str1 = 'Hello, ';
	const str2 = 'World!';
	resultTwelve.textContent = ('Hello, ' + 'World!');
};
...
const makeTwentyOne = () => {
	resultTwentyOne.textContent = Math.floor(Math.random() * (10 - 1 + 1)) + 1;
  }
